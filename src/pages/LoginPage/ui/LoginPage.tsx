...
import NavigationBtn from "../../../processes/NavigationBtn/NavigationBtn";
    ...
    return (
        <section className={styles.content}>
            ...
            <div className={styles.info}>
                <p>Авторизуйтесь через edu.donstu.ru</p>
                <div className={styles.btns}>
                    <div>
                        <NavigationBtn url="https://lk.donstu.ru/WebApp/#/Authorize?client_id=535684&redirect_uri=https%3A%2F%2Fdws.donstu.ru%2Fcallback&state=Ert2q5Z">
                            Авторизоваться
                        </NavigationBtn>
                    </div>
                    <div>
                ...
                <div className={styles.support}>
                    <div onClick={changeVisible}>Нет личного кабинета?</div>
                    <div
                        className={`${styles.inactive} ${
                            visible && styles.active
                        }`}
                    >
                        Обратитесь в 1-455a или позвоните:{" "}
